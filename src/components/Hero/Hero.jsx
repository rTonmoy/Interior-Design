...
const ImageList = [
  {
    id: 1,
    img: Book1,
    title: "Where Luxury and Comfort Meet",
    description:
  ...
  },
  {
    id: 2,
    img: Book2,
    title: "Modern Design Meets Natural Elegance",
    description:
  ...
  },
  {
    id: 3,
    img: Book3,
    title: "Bold Interiors with a Natural Touch",
    description:
...
const Hero = ({ handleOrderPopup }) => {
  ...
  const [title, setTitle] = React.useState("Modern Design Meets Natural Elegance");
